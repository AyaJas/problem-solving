...
const objLat = (obj) => {
    ...
    let sol = `my name is ${entries[0][1].charAt(0).toUpperCase() + entries[0][1].slice(1)} ${entries[1][1].charAt(0).toUpperCase() + entries[1][1].slice(1)} I am ${entries[2][1]} YO, and I love ${entries[3][1]}.`;
    return sol;
};
